import {RequestLink} from './RequestLink.tsx';
import {DashboardUpdatesSkeleton} from './DashboardUpdatesSkeleton.tsx';
import {useGetCommentsQuery, useGetPostsQuery} from '../api/dashboard-api.ts';
