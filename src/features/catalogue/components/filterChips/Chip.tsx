...
export const Chip = ({filterItem, onRemove}: ChipProps) => {
  return (
    <div
      className="flex items-center gap-1.5 bg-blue-50 border border-blue-100 cursor-pointer text-blue-700 px-2.5 py-1 rounded-md text-xs font-medium group transition-all hover:bg-blue-100">
